"""E002 fixed-checkpoint diagnostic: one eligible sign reversal.
...
def main():
    parser = argparse.ArgumentParser(
        description="E002 fixed-checkpoint sign-reversal diagnostic"
    )
    parser.add_argument(
        "--clean-result",
        required=True,
    ...
    expected_output = Path(
        "results/e002/"
        "e002_k1_q025_seed0_sign_reversal_diagnostic_attempt01.json"
    )
    ...
    result = {
        "gate": "E002-fixed-checkpoint-sign-reversal-diagnostic",
        ...
        "limitations": [
            ...
            "At q=1/4, Theorem 5.3 predicts zero magnetic-adjacency drift for this restricted sign reversal",
    ...
    print("E002 SIGN-REVERSAL DIAGNOSTIC: PASS")
