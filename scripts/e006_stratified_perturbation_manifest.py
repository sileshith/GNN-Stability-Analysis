"""Build the E006 SDSBM-aware perturbation manifest without training."""
...
def query_forbidden_pairs(shared) -> set[tuple[int, int]]:
    forbidden = set()
...
def main() -> int:
    ...
    for index, (source, target) in enumerate(pairs):
        ...
        if (source, target) in forbidden:
            exclusions["query_or_reverse_query"] += 1
            continue
    ...
    manifest = {
        "artifact": "E006 SDSBM-aware stratified perturbation manifest",
        ...
        "eligibility": {
            ...
            "forbidden_ordered_pair_count": len(forbidden),
        ...
        "limitations": [
            ...
            (
                "No perturbation budget is selected until stratum counts "
                "are observed."
            ),
            (
    ...
    print("E006_STRATIFIED_PERTURBATION_MANIFEST: PASS")
    print("OUTPUT:", OUTPUT)
    print(
        "COMMUNITY_COUNTS:",
